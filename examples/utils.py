...
def frame_to_bgr_image(frame: VideoFrame) -> Union[Optional[np.array], Any]:
    ...
    width = frame.get_width()    # 1080
    height = frame.get_height() # 1920
    color_format = frame.get_format() # OBFormat.MJPG
    data = np.asanyarray(frame.get_data()) # print("data",data.shape) (227306,)
    image = np.zeros((height, width, 3), dtype=np.uint8) # print("image",image.shape) (1080, 1920, 3)
